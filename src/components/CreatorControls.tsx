...
export const CreatorControls: React.FC<CreatorControlsProps> = ({
  ...
  const handleSortChange = (sortBy: 'timestamp' | 'votes' | 'author') => {
    const newOrder = room.settings.sortBy === sortBy && room.settings.sortOrder === 'desc' ? 'asc' : 'desc';
      ...
      <div className="bg-white rounded-2xl shadow-xl max-w-2xl w-full max-h-[80vh] overflow-y-auto">
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-bold text-gray-900">Creator Controls</h2>
            <button
              onClick={onToggle}
        ...
        <div className="p-6 space-y-6">
          {/* Sorting Controls */}
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Sort Cards</h3>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  <span className="font-medium text-gray-900">Show Authors to Creator</span>
                  <p className="text-sm text-gray-500">You can see who created each card</p>
                </div>
                <input
                  type="checkbox"
                  checked={room.settings.showAuthorToCreator}
                  onChange={(e) => onUpdateRoom({
                    settings: {
                      ...room.settings,
              ...
              <div className="flex items-center justify-between">
                <div>
                  <span className="font-medium text-gray-900">Allow Anonymous Cards</span>
                  <p className="text-sm text-gray-500">Users can add cards without showing their name</p>
                </div>
                <input
                  type="checkbox"
